...
def encoding_V1_Transform(df_train:pd.DataFrame, df_test:pd.DataFrame, Target:str):
...
def encoding_V2_Transform(df_train:pd.DataFrame, df_test:pd.DataFrame, Target:str):
...
def encoding_V3_Transform(df_train:pd.DataFrame, df_test:pd.DataFrame, Target:str):
...
def encoding_V4_Transform(df_train:pd.DataFrame, df_test:pd.DataFrame, Target:str):
...
############################## Transformation Procediment ##############################
    ...
    if Encoding_Method=="Encoding Version 1":
        Train_DF, Test_DF=encoding_V1_Transform(Train_DF, Test_DF,Target)
    elif Encoding_Method=="Encoding Version 2":
        Train_DF, Test_DF=encoding_V2_Transform(Train_DF, Test_DF,Target)
    elif Encoding_Method=="Encoding Version 3":
        Train_DF, Test_DF=encoding_V3_Transform(Train_DF, Test_DF,Target)
    elif Encoding_Method=="Encoding Version 4":
        Train_DF, Test_DF=encoding_V4_Transform(Train_DF, Test_DF,Target)
